// apps/organizer/src/components/layout/Topbar.tsx
'use client';
    ...
    return (
        <header className="h-14 border-b border-[var(--color-gray-200)] bg-white flex items-center justify-between px-6 sticky top-0 z-10">
            ...
            <div className="flex items-center gap-4">
                <button className="text-[var(--color-gray-600)] hover:text-[var(--color-gray-900)]">
                    <i className="ri-notification-3-line text-lg" />
                </button>
                <button
                    onClick={logout}
                    className="flex items-center gap-1.5 text-sm text-[var(--color-gray-600)] hover:text-[var(--color-gray-900)]"
                >
